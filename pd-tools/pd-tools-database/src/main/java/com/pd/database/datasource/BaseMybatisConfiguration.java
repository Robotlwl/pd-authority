package com.pd.database.datasource;

import com.baomidou.mybatisplus.core.handlers.MetaObjectHandler;
import com.baomidou.mybatisplus.core.parser.ISqlParser;
import com.baomidou.mybatisplus.extension.parsers.BlockAttackSqlParser;
import com.baomidou.mybatisplus.extension.plugins.PaginationInterceptor;
import com.pd.core.base.id.IdGenerate;
import com.pd.core.base.id.SnowflakeIdGenerate;
import com.pd.database.mybatis.typehandler.FullLikeTypeHandler;
import com.pd.database.mybatis.typehandler.LeftLikeTypeHandler;
import com.pd.database.mybatis.typehandler.RightLikeTypeHandler;
import com.pd.database.parsers.TenantWebMvcConfigurer;
...
public abstract class BaseMybatisConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(name = "pd.database.isMultiTenant", havingValue = "true", matchIfMissing = true)
