package com.pd.auth.controller.core;

import com.baomidou.mybatisplus.core.metadata.IPage;
import com.pd.auth.dto.core.OrgSaveDTO;
import com.pd.auth.dto.core.OrgTreeDTO;
import com.pd.auth.dto.core.OrgUpdateDTO;
import com.pd.auth.entity.core.Org;
import com.pd.auth.service.core.OrgService;
import com.pd.core.base.BaseController;
import com.pd.core.base.R;
import com.pd.core.base.entity.SuperEntity;
import com.pd.core.utils.BizAssert;
import com.pd.core.utils.TreeUtil;
...
import static com.pd.core.utils.StrPool.DEF_PARENT_ID;
import static com.pd.core.utils.StrPool.DEF_ROOT_PATH;
...
public class OrgController extends BaseController {
    ...
    @GetMapping("/tree")
    @SysLog("查询系统所有的组织树")
    public R<List<OrgTreeDTO>> tree(@RequestParam(value = "name", required = false) String name, @RequestParam(value = "status", required = false) Boolean status) {
        List<Org> list = this.orgService.list(Wraps.<Org>lbQ().like(Org::getName, name).eq(Org::getStatus, status).orderByAsc(Org::getSortValue));
